...
p_imagens <- dir('img', full.names = TRUE, pattern = 'aecio')
...
d_emocoes <- readRDS('d_emocoes.rds')
```
...
A Figura \@ref(fig:each) mostra os resultados individuais das imagens. O primeiro resultado faz sentido, já que o Aécio está nitidamente rindo. Em todos os casos, é possível interpretar os resultados olhando a imagem. Por exemplo, o caso com "tristeza" mais alto é o que observamos as sombrancelhas mais caídas.

```{r each, fig.height=8, fig.width=7, fig.align = 'center', echo=FALSE, fig.cap='Emoções do Aécio em cada imagem.'}
