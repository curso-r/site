...
[**5. lubridate**](https://cran.r-project.org/web/packages/lubridate/vignettes/lubridate.html) (manipulação de datas)
...
As principais funções são `gather()` e `spread()`. Elas pivotam/despivotam data.frames, ou derretem/condensam data.frames. Ela merece nosso quarto lugar porque possui uma grande sinergia com os terceiro e segundo lugares. Não raramente precisamos rearranjar conjunto de colunas em um par de colunas chave/valor ou vice-versa com facilidade. Pivotar/despivotar é particularmente muito chato de fazer em SQL. E o [tidyr](https://blog.rstudio.org/2014/07/22/introducing-tidyr/) possui outras funções úteis tbm (ex: `unite()`, `separete()`).
