...
```{r, echo=FALSE, fig.width=50, fig.height=30}
library(magick)
library(magrittr)
image_read('img/views_porta_png.png') %>%
  plot
```
...
```{r, echo=FALSE, fig.width=50, fig.height=40}
x <- image_read('img/likes-dislikes_porta_png.png')
plot(x)
```
