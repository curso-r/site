...
knitr::include_graphics("2017-08-18-r_telegram_bitcoin/r_telegram.gif")
```
...
```{r, fig.align='center', echo=FALSE}
knitr::include_graphics("2017-08-18-r_telegram_bitcoin/serie_bitcoin.png")
```
...
```{r, fig.align='center', echo=FALSE}
knitr::include_graphics("2017-08-18-r_telegram_bitcoin/Renvirom_1.png")
```
