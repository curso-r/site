...
knitr::include_graphics("/blog/2017-08-19-r-telegram-bitcoin/r_telegram.gif")
```
...
```{r, fig.align='center', echo=FALSE}
knitr::include_graphics("/blog/2017-08-19-r-telegram-bitcoin/serie_bitcoin.png")
```
...
1) Vá ao seu telegram e procure pelo BotFather como se estivesse procurando uma pessoa da sua lista de contatos. Abra uma conversa com ele!
...
3) Agora copie e cole o token que o BotFather te enviou no `.Renvirom`. O meu bot tem o username `AthosDamianiBot`, então eu devo colocar o nome da variável assim:

```{r, fig.align='center', echo=FALSE}
knitr::include_graphics("/blog/2017-08-19-r-telegram-bitcoin/Renvirom_1.png")
```
...
3) No R, chame o método `bot$getUpdates()` para pegar no R as mensagens que você envou a ele e, finalmente, encontre o `chat_id` escondido no `msgs`.
