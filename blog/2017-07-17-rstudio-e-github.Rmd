...
knitr::include_graphics("2017-07-17-rstudio-e-github/fluxo_github_rstudio.png")
```
...
```{r, fig.align='center', fig.height = 5, echo=FALSE}
knitr::include_graphics("2017-07-17-rstudio-e-github/passo_1_criar_repo.gif")
```
...
```{r, fig.align='center', fig.height = 5, echo=FALSE}
knitr::include_graphics("2017-07-17-rstudio-e-github/passo_2_criacao_do_rproj_pt2.gif")
```
...
```{r, fig.align='center', fig.height = 5, echo=FALSE}
knitr::include_graphics("2017-07-17-rstudio-e-github/passo_3_commit_1.gif")
```
...
```{r, fig.align='center', fig.height = 5, echo=FALSE}
knitr::include_graphics("2017-07-17-rstudio-e-github/passo_3_commit_2.gif")
```
...
```{r, fig.align='center', fig.height = 5, echo=FALSE}
knitr::include_graphics("2017-07-17-rstudio-e-github/passo_4_push.gif")
```
...
knitr::include_graphics("2017-07-17-rstudio-e-github/github_dps_do_push.png")
```
...
```{r, fig.align='center', fig.height = 15, echo=FALSE}
knitr::include_graphics("2017-07-17-rstudio-e-github/passo_5_pull.gif")
```
...
```{r, fig.align='center', fig.height = 15, echo=FALSE}
knitr::include_graphics("2017-07-17-rstudio-e-github/passo_extra_issue.gif")
```
