...
De fato, essa matrix ocupa bastante memória:
...
`x*y`, `x+y`, `x/y`, `x%*%y`, `x[1,1]`, etc. como se fossem matrizes normais.
...
Nota: a inspiração para esse post foi [esse post](http://www.johnmyleswhite.com/notebook/2011/10/31/using-sparse-matrices-in-r/) de 2011 do John Myles White
