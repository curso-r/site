...
```{r, echo=FALSE, fig.width=50, fig.height=40, eval = TRUE}
library(magick)
x <- image_read('img/bvs.jpg')
plot(x)
```

```{r, echo=FALSE, fig.width=50, fig.height=40, eval = TRUE}
x <- image_read('img/cw.jpg')
plot(x)
```
...
```{r, echo=FALSE, fig.width=40, fig.height=20, eval = TRUE}
x <- image_read('img/paleta_bvs.jpeg')
plot(x)
```
...
```{r, echo=FALSE, fig.width=40, fig.height=20, eval = TRUE}
x <- image_read('img/paleta_cw.jpeg')
plot(x)
```
...
```{r, echo=FALSE, fig.width=40, fig.height=20, eval = TRUE}
x <- image_read('img/paleta_poster_bvs.jpeg')
plot(x)
```
...
```{r, echo=FALSE, fig.width=40, fig.height=20, eval = TRUE}
x <- image_read('img/paleta_poster_cw.jpeg')
plot(x)
```
