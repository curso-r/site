...
knitr::opts_chunk$set(eval = FALSE, echo = TRUE, message = FALSE, error = FALSE, warning = FALSE, fig.align = 'center')
```
...
```{r, eval = T, echo = F}
dados <- readRDS("2017-04-28-porta-dos-fundos-decadencia-revisited/dados.rds")
```
