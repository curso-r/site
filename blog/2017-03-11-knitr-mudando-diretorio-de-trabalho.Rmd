...
date: "2017-03-11T23:26:00+03:00"
...
Quando estamos trabalhando com arquivos Rmarkdown no Rstudio, o diretório de trabalho é a própria pasta onde o `Rmd` está salvo. Assim, se o nosso relatório tem algum imput (banco de dados, arquivos com código em R ou imagens, por exemplo), esses arquivos precisam estar no diretório de trabalho. Isso pode ser uma chateação se você está dentro de um projeto e organizou os arquivos de forma diferente: banco de dados em uma pasta, `.R` em outra, imagens em outra, outputs em outra...

A primeira ideia que vem à cabeça é usar a função `setwd()` dentro de algum chunk para mudar o diretório de trabalho dentro do arquivo `Rmd`. No entanto, se fizermos isso, o diretório de trabalho será mudado para aquele chunk, mas será mudado de volta após a sua execução. Veja o `warning` abaixo.
