...
Clique no link: <a href='https://github.com/new', target='blank'>https://github.com/new</a>
...
```{r echo=FALSE}
plot(magick::image_read('documentacao.png'))
```
...
meme:::plot.meme(readRDS('allthehings.rds'))
```
...
#                                   username = 'jtrecenti', password = 'orelhatres')
# saveRDS(allthethings, 'allthehings.rds')
meme:::plot.meme(readRDS('dicaprio.rds'))
```
