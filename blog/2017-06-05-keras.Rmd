...
```{r echo=FALSE}
plot(magick::image_read('img/dfalbel.jpg'))
```
...
No futuro, postaremos tutoriais sobre o Keras e como estamos utilizando essa biblioteca para quebrar CAPTCHAs usando métodos bastante inovadores. Enquanto isso, você pode olhar um [tutorial para o pacote `keras` nesse link](https://rstudio.github.io/keras/).
