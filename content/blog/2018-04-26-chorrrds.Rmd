...
date: "2018-04-26T13:07:31+02:00"
tags: ["musica"]
...
knitr::include_graphics("/blog/2018-04-26-chorrrds/media-acordes-musica.png")
```
...
```{r, echo=FALSE, eval=TRUE, fig.align='center'}
knitr::include_graphics("/blog/2018-04-26-chorrrds/stats-artistas.png")
```
