...
O `skimr` ainda não está no CRAN, então para instalar recomendamos utilizar o `devtools` para instalar direto do GitHub, conforme códico abaixo. Note que também será necessário instalar o pacote `colformat` do Hadley.
...
e depois aplicar a função `skim_with()`:
