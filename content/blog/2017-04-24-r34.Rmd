...
Veja esse exemplo extraído do livro [Efficient R](https://csgillespie.github.io/efficientR/programming.html). Observe a existência de um `<bytecode ...>` na parte de baixo de uma das funções. Isso significa que o pacote `compiler` converteu essa função que pode ser interpretada mais rápido.
