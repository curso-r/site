...
Conforme fui conhecendo a Estatística, eu descobri que ela é a profissão mais nerd que existe\footnote{Se você ainda vê alguma conotação negativa na palavra *nerd*, mande as minha lembranças aos anos 90. :D}.  Eu sustento essa opinião porque a melhor definição de nerd que já escutei é "pessoa ama aprender" e, graças à Estatística, tenho a oportunidade de estudar *muita* coisa diferente. 
