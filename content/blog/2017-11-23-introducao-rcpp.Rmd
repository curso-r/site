...
Vejamos agora um exemplo simples de como chamar código C++ do R. O jeito mais fácil de fazer isso é através da função `cppFunction()`: ela recebe uma string que será interpretada como fuma função em C++.
