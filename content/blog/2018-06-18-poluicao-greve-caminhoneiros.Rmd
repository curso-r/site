...
tab <- map2_dfr(
  ...
  mutate(
    Ibirapuera = ifelse(Ibirapuera == "NaN%", "N/A", Ibirapuera),
    Osasco = ifelse(Osasco == "NaN%", "N/A", Osasco)
  ) %>% 
...
Como são muitos gráficos e tabelas, vou apresentar apenas alguns resultados aqui no post. O restante está disponível [neste flexdashboard](/flexdashboards/greve-caminhoneiros/flexdash-greve-caminhoneiros.html).
