...
Mas a cidade da diversidade só é o que é porque temos muita, muita gente nela. O município tem 12 milhões de habitantes. Esse número é tão grande que temos um paulistano para cada 17 brasileiros! Se São Paulo fosse um país, [seria o 77o do mundo](https://en.wikipedia.org/wiki/List_of_countries_and_dependencies_by_population), ganhando de países como a Bélgica, Grécia, Portugal, Bolívia e muitas outras.
...
knitr::include_graphics('https://raw.githubusercontent.com/curso-r/site/master/content/blog/img/knapsack.svg')
```
...
- $x=(x_1,\dots,x_n)^\top$ é o vetor que seleciona os municípios. Se o municípop $i$ faz parte da solução $x_i=1$ e, caso contrário, $x_i=0$. 
...
1. Escolher outos municípios com maior razão na ordem até não ser possível incluir mais nenhum município.
...
A Tabela \@ref(tab:dif2) mostra a diferença dos resultados dos dois métodos. A solução ótima fica
