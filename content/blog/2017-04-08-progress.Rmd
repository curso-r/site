...
Infelizmente, as funções do `purrr` ainda[^1] não têm um parâmetro para barras de progresso. Enquanto isso, podemos utilizar o `dplyr::progress_estimated()` mesmo.
...
library(magrittr)
library(tidyverse)
benchmark <- readRDS('benchmark_progress.rds')
benchmark %>% 
...
m <- readRDS('for_microbenchmark.rds')
