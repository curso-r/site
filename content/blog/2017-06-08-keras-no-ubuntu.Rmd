...
tags: ["r", "keras", "tensorflow", "ubuntu", "anaconda"]
categories: ["r"]
banner: "img/banners/keras_no_ubuntu.png"
author: ["Athos"]
...
Esse tutorial ensinará como instalar o [Anaconda](https://docs.continuum.io/) com Python 3.5 em um servidor Ubuntu 16.04 + Keras para R. Compilei um passo a passo mais simplificado dos posts que usei pra conseguir usar o Keras. Então ao final desse post você terá o Keras para R pronto para abalar os profundos mares da aprendizagem de máquinas.
...
**Passo 6)** Escreva `yes` para aceitar os termos. Deve aparecer um prompt como o mostrado abaixo: hora de escolha o local de instalação.
...
**Passo 7)** Solte um ENTER caso goste do local padrão oferecido. Daí a pergunta seguinte é para saber se você gostaria de fazer o comando `conda` funcionar quando for chamado no terminal. Pode aceitar.
