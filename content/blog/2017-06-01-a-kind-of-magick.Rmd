...
image_read(path = "img/freddie_1.jpg") %>% plot
```
...
```{r, echo = FALSE, fig.width = 4, fig.height = 3}
image_read(path = "img/freddie_2.jpg") %>% plot
```
...
```{r, echo = FALSE, fig.width = 4, fig.height = 3}
image_read(path = "img/freddie_3.jpg") %>% plot
```
...
```{r, echo = FALSE, fig.width = 4, fig.height = 3}
image_read(path = "img/freddie_4.jpg") %>% plot
```
...
```{r, echo = FALSE, fig.width = 4, fig.height = 3}
image_read(path = "img/freddie_5.jpg") %>% plot
```
...
image_read(path = "img/freddie_6.jpg")
```
...
```{r, echo = FALSE, fig.width = 8, fig.height = 7}
image_read(path = "img/freddie_7.jpg") %>% plot
```

```{r, eval = FALSE}
image_charcoal(freddie_resized)
```

```{r, echo = FALSE,fig.width = 8, fig.height = 7}
image_read(path = "img/freddie_8.jpg") %>% plot
```
...
```{r, echo = FALSE, fig.width = 8, fig.height = 7}
image_read(path = "img/freddie_9.jpg") %>% plot
```
...
library(grid)
qplot(speed, dist, data = cars, geom = c("point", "smooth"))
grid.raster(image_read(path = "img/freddie_1.jpg"), width = 0.15, height = 0.3,
            hjust = -2, vjust = 1)
```
