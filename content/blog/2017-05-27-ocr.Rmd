...
cat(stringr::str_trunc(txt[1], 500))
```
...
<object data="/blog/2017-05-27-ocr/pdf_compras.pdf" width="100%" height="375" type='application/pdf'></object>
...
cat(stringr::str_trunc(txt, 300))
```

```{r echo=FALSE}
cat(stringr::str_trunc(readRDS("2017-05-27-ocr/txt_ocr.rds"), 300))
```
