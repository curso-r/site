...
knitr::include_graphics('/blog/2017-11-03-music01/music-download.png')
```
...
```{r, echo=FALSE, out.width='80%', fig.align='center'}
knitr::include_graphics('/blog/2017-11-03-music01/music-generate.png')
```
...
```{r, echo=FALSE, out.width='80%', fig.align='center'}
knitr::include_graphics('/blog/2017-11-03-music01/music-transform.png')
```
...
```{r note, fig.width=2, fig.height=1.5, message=FALSE, warning=FALSE}
note %>% 
  plot()
```
...
Por enquanto vou acabar por aqui. Convido vocês a usar o `music21` e experimentar suas funcionalidades. Adicionem issues em https://github.com/jtrecenti/music21/issues e mandem pergundas nos comentários.
