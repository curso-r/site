...
knitr::include_graphics('/blog/img/music-download.png')
```
...
```{r, echo=FALSE, out.width='80%', fig.align='center'}
knitr::include_graphics('/blog/img/music-generate.png')
```
...
```{r, echo=FALSE, out.width='80%', fig.align='center'}
knitr::include_graphics('/blog/img/music-transform.png')
```
